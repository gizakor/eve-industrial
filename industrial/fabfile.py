...
def deploy():
    ...
    run("cd /var/django/eve-industrial/industrial&& exec /var/django/eve-industrial/env/bin/gunicorn  --workers=4 --bind=0.0.0.0:9000 industrial.wsgi:application", pty=False)